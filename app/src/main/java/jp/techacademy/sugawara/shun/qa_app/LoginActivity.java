...
public class LoginActivity extends AppCompatActivity {
    ...
    FirebaseAuth mAuth;
    OnCompleteListener<AuthResult> mCreateAccontListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //アカウント作成処理時
        mCreateAccontListener = new OnCompleteListener<AuthResult>() {
            @Override
    ...
    private void createAccount(String email,String password){
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(mCreateAccontListener);
