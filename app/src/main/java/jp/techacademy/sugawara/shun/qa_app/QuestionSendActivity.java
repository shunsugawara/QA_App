...
public class QuestionSendActivity extends AppCompatActivity
    ...
    public void onClick(View v){
        if(v == mImageView){
            ...
            im.hideSoftInputFromWindow(mImageView.getWindowToken(),InputMethodManager.HIDE_NOT_ALWAYS);
            ...
            if(body.length() == 0){
                Snackbar.make(v,"本文を入力してください",Snackbar.LENGTH_LONG).show();
                return;
            }
    ...
    public void onComplete(DatabaseError databaseError,DatabaseReference databaseReference){
        ...
        if(databaseError == null){
            ...
            //Snackbar.make(findViewById(R.id.content),Snackbar.LENGTH_LONG).show();
        }
    }
